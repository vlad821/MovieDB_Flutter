          ...
          if (state is TvInfoLoading) {
            return Center(
              child: SpinKitSquareCircle(
                color: Color.fromARGB(255, 255, 240, 23),
                size: 50.0,
              ),
            );
                ...
                slivers: [
                      ...
                      if (state.videos['results'].isNotEmpty)
                        if (state.videos['results'][0]['site'] == 'YouTube')
                          SliverToBoxAdapter(
                            ...
                            quarterTurns: 4,
                            child: HtmlWidget(
                                '<iframe width="${MediaQuery.of(context).size.width}" height="500" src="https://www.youtube.com/embed/${state.videos['results'][0]['key']}"  allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen"></iframe>',
                              //  webView: true
                                ),
                          ))
                        else
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      color: Color.fromARGB(255, 192, 200, 195),
                    ...
                    if (state.providers['results']['US'].containsKey('buy'))
                      SliverToBoxAdapter(
                        child: CompanyConatainer(
                          ...
                          url: state.providers['results']['US']['link'], key: GlobalKey(),
                        ),
                      ),
                  if (state.providers['results'].containsKey('US'))
                    ...
                    if (state.similar['results'].isNotEmpty)
                      SliverToBoxAdapter(
                        child: TvContainerSimilar(
                          listPaths: state.similar['results'], key: GlobalKey(),
                        ),
                      ),
                ],
              ),
