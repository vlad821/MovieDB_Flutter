  ...
  Stream<HomePageState> mapEventToState(
    ...
    if (event is HomePageEvent) {
      ...
      try {
        ...
        var url = Uri.parse('https://api.themoviedb.org/3/trending/movie/week?api_key=84ebd14770d7675041b532f1d88ce324');
        final response = await http.get(url);
        final data1 = json.decode(response.body);
        var list = data1['results'];


        var urltv = Uri.parse('https://api.themoviedb.org/3/trending/tv/week?api_key=84ebd14770d7675041b532f1d88ce324');
        final responsetv = await http.get(urltv);
        final datatv = json.decode(responsetv.body);
        var listtv = datatv['results'];


        var urlPopular = Uri.parse( 'https://api.themoviedb.org/3/movie/popular?api_key=84ebd14770d7675041b532f1d88ce324');
        ...
        var urlPopulartv = Uri.parse( 'https://api.themoviedb.org/3/tv/popular?api_key=84ebd14770d7675041b532f1d88ce324');
